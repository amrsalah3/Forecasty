...
abstract class Hilt_MasterForecastFragment extends Fragment implements GeneratedComponentManager<Object> {
  ...
  Hilt_MasterForecastFragment() {
    super();
  }

  Hilt_MasterForecastFragment(int contentLayoutId) {
  ...
  protected void inject() {
    ((MasterForecastFragment_GeneratedInjector) generatedComponent()).injectMasterForecastFragment(UnsafeCasts.<MasterForecastFragment>unsafeCast(this));
  }
